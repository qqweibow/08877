...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@msd5n.onmicrosoft.com',
  ...
  protectedRoutes: ['/🔫M-------F-------F', '/🔫M-------F-------F/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:ling886676@gmail.com',
